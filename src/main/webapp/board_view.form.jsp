...
<link rel="stylesheet" href="https://image.osulloc.com/kr/ko/static_cdj/css/mypage1.css?ver=20240222_1">
<link rel="stylesheet" href="https://image.osulloc.com/kr/ko/static_cdj/css/mypage2.css?ver=20240115">
  ...
  <script type="text/javascript">
	 /*  window._rblqueue = window._rblqueue || [];
	  ...
	  if(realBool){//운영
	  	...
	  	var ucstmid = CryptoJS.SHA512('207235428').toString();
...
<script type="text/javascript">
	...
	// 태깅을위한 전역변수 선언
	// 1. 공통
	var AP_DATA_GCID = '9d6f033f93af36e7f7ad2d5a2f072418b74cb0127fd82bfab94b49859b154387d4c197e388da262873f8f95b9a2f64ea0e9a51fe0d4d9d05a133b0319652fa10';
	var AP_DATA_CID  = '0663e289733ca9ad7f74b33e164f05eadd74b6def80511a8bb61445646b3bb7b20cde02a675f52e964bb2f0b9d2d42462aba3d2ddfc9f89a10d1a91a64be635a';
	var AP_DATA_ISMEMBER = 'O';
	...
	var AP_DATA_PAGENAME = '공지사항 상세';
	var AP_DATA_PAGETYPE = '';
	var AP_DATA_BREAD = 'Home > 고객센터 > 공지사항 > 공지사항 상세';
		...
		<div class="mo_nav_header in">
					...
					<div class="logOn_top_box">
						<a href="https://www.osulloc.com/kr/ko/mypage" style="display: flex; align-items: center;">
                            ...
                            <p class="name"><em class="pt">박성현</em>님</p>
                            <!-- 등급에 따라 다르게 표시 -->
                            <div class="grade_tag">
			...
			<div class="mo_nav_util in">
				...
				<div class="logOn_box">
					<div class="top">
						...
						<div class="item"><a href="https://www.osulloc.com/kr/ko/shop/cart" data-track-name="Header 장바구니">장바구니 <span class="count">0</span></a></div>
    ...
    function bannerShow() {
 	...
 	window.onload = function() {
	  ...
	  if('true' == 'false'){
		...
		var chkCid = "1177434442.1710208781";
				...
				<div class="w1200">
					<div class="notice_list_view">
						<div class="view_header">
							...
							<p class="subject">[공지] 오설록몰 개인정보처리방침 변경 안내 (24. 02. 29)</p>
						...
						<div class="view_con">
							<!-- .text_box 텍스트 영역 -->
								...
								<div class="text_box">
									<p>안녕하세요.&nbsp;차 한 잔의 쉼을 전하는 오설록입니다.<br>
 아래의 사유로 개인정보처리방침의 일부 내용이 변경될 예정임을 고객님들께 알려드립니다.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><br><strong>* 제3조 2항</strong><br>
 &nbsp;</p>
<p>- 계약 종료로 인한 수탁사 리스트 수정 &nbsp;<strong>[삭제]</strong></p>
<p>&nbsp; : (주)광주요, &nbsp;소로시, &nbsp;주식회사 소일베이커인터네셔널 &nbsp;</p>
<p>&nbsp;</p>
<p><br>
 - 신규 계약 업체 반영 <strong>[추가]</strong></p>
<p>&nbsp; : (주)새뉴, &nbsp;인소일, &nbsp;탁가온 주식회사, &nbsp;김별희 &nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>변경되는 개인정보처리방침은 2024년 3월 8일부터 시행될 예정입니다.</p>
<p>감사합니다!</p>
								</div>
						...
						<div class="btn_box">
							<button type="button" class="button" title="목록보기" onclick="location.href='/kr/ko/cs/notice/news?'">목록보기</button>
						</div>
					</div>
				</div>
			</section>
